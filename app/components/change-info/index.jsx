...
const ChangeInfo = ({ resAdded, resChanged, resDestroyed }) => {
      ...
      info = {
        text: (
          <span className={styles.text}>
            <span className='code-number code-number-add'>
              +{resAdded || 0}
            </span>
        ...
        toolText: (
          <span>
            <span>
              {resAdded}&nbsp;{t('define.change.add')} <br />{' '}
            </span>
            <span>
              {resChanged}&nbsp;{t('define.change.modify')} <br />{' '}
            </span>
            <span>
              {resDestroyed}&nbsp;{t('define.change.delete')} <br />{' '}
            </span>
          </span>
        ),
      };
