...
const AppHeader = props => {
  ...
  const [devManualTooltipVisible, setDevManualTooltipVisible] = useState(
    localStorage.newbieGuide_devManual === 'true',
  );
  const menuType =
    locationPathName.indexOf('compliance') !== -1 ? 'compliance' : 'execute';
  ...
  useEffect(() => {
    if (
      orgId &&
      !(
        orgId !== preStateRef.current.orgId &&
        projectId &&
        projectId === preStateRef.current.projectId
      )
    ) {
      dispatch({
  ...
  return (
    <div className={`idcos-app-header ${theme || ''}`}>
      <div className='inner'>
        <div
          className='logo'
          onClick={() => {
        ...
        <div className='rParts'>
          {!!orgId && locationPathName !== '/' ? (
            <>
              <SeniorSelect
                ...
                showSearch={true}
                searchPlaceholder={t(
                  'define.header.organization.search.placeholder',
                )}
                ...
                seniorSelectfooter={
                  <div className={styles.seniorSelectfooter}>
                    <div className='more' onClick={() => history.push('/')}>
                      ...
                      {t('define.header.organization.more')}
                    </div>
                    <div
                      className='more'
                      onClick={() => {
                    ...
                    >
                      ...
                      {t('define.header.organization.create')}
                    </div>
                  </div>
                }
              />
          ...
          <div className='user'>
              ...
              <>
                {
                  ...
                  menuType === 'execute' ? (
                    <Tooltip
                      ...
                      color='#08857C'
                    >
                      <span onClick={() => changeMenu('compliance')}>
                        {<SwitchComplianceIcon />}
                      </span>
                    </Tooltip>
                  ) : (
                    ...
                    <Tooltip
                      ...
                      color='#08857C'
                    >
                      <span onClick={() => changeMenu('execute')}>
                        {<SwitchComplianceIcon />}
                      </span>
                    </Tooltip>
                  )
            ...
            <Tooltip
              ...
              color='#08857C'
            >
              <span onClick={() => window.open('https://store.cloudiac.org/')}>
                {<ToExchangeIcon />}
              </span>
            </Tooltip>
            {language === 'zh' ? (
              ...
              title={
                devManualTooltipVisible ? (
                  <div className='dev-manual-tooltip-content'>
                    ...
                    <Button
                      type='primary'
                      onClick={() => onCloseDevManualTooltip()}
                    >
                      {t('define.gotIt')}
                    </Button>
                  </div>
            ...
            >
              <Badge
                color={devManualTooltipVisible ? '#08857C' : null}
                offset={[-1, 3]}
              >
                <span
                  onClick={() =>
                    window.open(`${IAC_PUBLICITY_HOST}/markdown/docs/`)
                  }
                >
                  <QuestionCircleFilled />
                </span>
            ...
            <Tooltip
              ...
              color='#08857C'
            >
              <span onClick={() => history.push('/sys/status')}>
                <FundFilled />
              </span>
            </Tooltip>
            {userInfo.isAdmin && (
              <Tooltip
                ...
                color='#08857C'
              >
                <span onClick={() => history.push('/platform/statistics')}>
                  <DashboardIcon />
                </span>
              </Tooltip>
            )}
                ...
                <div className={styles.userDropContent}>
                  ...
                  <div className='body'>
                    ...
                    {userInfo.isAdmin ? (
                      <div
                        className='link-item'
                        onClick={() => history.push('/sys/setting')}
                      >
                        <span className='icon'>
                          <SettingFilled />
                        </span>
