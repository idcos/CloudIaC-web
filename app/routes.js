  ...
  return [
    {
      ...
      name: '组织',
      component: loadable(
        () => import('containers/org-select-page'),
        asyncLoadFallback,
      ),
      exact: true,
    },
      ...
      routes: [
        {
          ...
          name: '仪表盘',
          component: loadable(
            () => import('containers/compliance/dashboard'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: 'Stack',
          component: loadable(
            () => import('containers/compliance/compliance-config/ct'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '环境',
          component: loadable(
            () => import('containers/compliance/compliance-config/env'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '策略组',
          component: loadable(
            () => import('containers/compliance/policy-config/policy-group'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          component: loadable(
            () =>
              import(
                'containers/compliance/policy-config/policy-group/form-page'
              ),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '策略',
          component: loadable(
            () => import('containers/compliance/policy-config/policy'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          component: loadable(
            () =>
              import('containers/compliance/policy-config/policy/online-test'),
            asyncLoadFallback,
          ),
          exact: true,
        },
      ...
      routes: [
        {
          ...
          name: '项目信息：环境',
          component: loadable(
            () => import('containers/project/m-project/env'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '部署新环境：选择Stack',
          component: loadable(
            () => import('containers/project/m-project/env/deploy'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          component: loadable(
            () => import('containers/project/m-project/env/detail'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          component: loadable(
            () => import('containers/project/m-project/env/detail/task-detail'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '项目信息：Stack',
          component: loadable(
            () => import('containers/project/m-project/ct'),
            asyncLoadFallback,
          ),
          exact: true,
        },

        {
          ...
          name: '项目信息：变量',
          component: loadable(
            () => import('containers/project/m-project/variable'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '项目信息：设置',
          component: loadable(
            () => import('containers/project/m-project/setting'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '概览',
          component: loadable(
            () => import('containers/project/m-project/overview'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '资源发现',
          component: loadable(
            () => import('containers/project/m-project/resource-query'),
            asyncLoadFallback,
          ),
          exact: true,
        },
      ...
      routes: [
        {
          ...
          name: '资源发现',
          component: loadable(
            () => import('containers/org/m-org/resource-query'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '组织设置：概览',
          component: loadable(
            () => import('containers/org/m-org/overview'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '组织设置：项目',
          component: loadable(
            () => import('containers/org/m-org/project'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '组织设置：Stack',
          component: loadable(
            () => import('containers/org/m-org/ct'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '新建Stack',
          component: loadable(
            () => import('containers/org/m-org/ct/create'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '编辑Stack',
          component: loadable(
            () => import('containers/org/m-org/ct/update'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          path: '/org/:orgId/m-org-ct/importCT-exchange',
          name: '从Exchange导入',
          component: loadable(
            () => import('containers/org/m-org/ct/exchange'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '从Exchange导入',
          component: loadable(
            () => import('containers/org/m-org/ct/exchange/create'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '组织设置：变量',
          component: loadable(
            () => import('containers/org/m-org/variable'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '组织设置：设定',
          component: loadable(
            () => import('containers/org/m-org/setting'),
            asyncLoadFallback,
          ),
          exact: true,
        },
        {
          ...
          name: '项目信息：创建项目',
          component: loadable(
            () => import('containers/project/m-project/create'),
            asyncLoadFallback,
          ),
          exact: true,
        },
