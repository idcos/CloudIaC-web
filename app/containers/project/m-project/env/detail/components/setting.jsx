...
const Setting = () => {
  ...
  return (
    <div className={styles.depolySettingDetail}>
      <div className='scroll-wrapper'>
        ...
        >
          <div>
            ...
            <Card title={'CI/CD'} key={'deploy'} forceRender={true}>
              <Row
                style={{ height: '100%', marginBottom: 24 }}
                justify='space-between'
              >
                  ...
                  <Form.Item shouldUpdate={true}>
                    {({ getFieldValue }) => (
                      <>
                        ...
                        <Space size={8}>
                          <Tooltip
                            title={t('define.env.field.triggers.tooltip')}
                          >
                            <InfoCircleOutlined />
                          </Tooltip>
                          <Copy
                            disabled={
                              !PROJECT_OPERATOR || !getFieldValue('commit')
                            }
                    ...
                    {({ getFieldValue }) => (
                      <>
                        ...
                        <Space size={8}>
                          ...
                          <Copy
                            disabled={
                              !PROJECT_OPERATOR || !getFieldValue('prmr')
                            }
                            copyRequest={() => copyRequest()}
                          />
                        </Space>
            ...
            {PROJECT_OPERATOR ? (
              ...
              >
                <Button
                  ...
                  disabled={locked || (envId && !envInfo.id)}
                  type='primary'
                  onClick={() => onFinish()}
                >
            ...
            <Card title={t('define.other')}>
                  ...
                  {PROJECT_APPROVER && (
                    <div>
                      {!envInfo.locked ? (
                        ...
                        <Button onClick={() => onUnLock()} disabled={isDemo}>
              ...
              />
              <Row
                style={{ alignItems: 'center', margin: '22px 0px 26px 0px' }}
              >
                <Col span={21}>
                ...
                <Col span={3} style={{ textAlign: 'right' }}>
                  <Button
                    loading={fileLoading}
                    onClick={showConfirm}
                    disabled={!envCanArchive}
                  >
                    {t('define.env.action.archive')}
                  </Button>
                </Col>
              </Row>
            </Card>
