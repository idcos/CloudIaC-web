  ...
  return (
    <div className={styles.resource_item}>
      <div className={styles.header}>
        ...
        <div className={styles.item}>
          ...
          <span className={styles.value}>
            <a
              onClick={() => {
                history.push(
                  `/org/${curOrg.id}/project/${projectId}/m-project-env/detail/${envId}`,
                );
              }}
            >
        ...
        <div className={styles.item}>
          <span className={styles.label}>
            {t('define.page.resource.resourceName')}
          </span>
      ...
      <div
        className={classNames(
          styles.json,
          isUnfold ? styles.unfold : undefined,
        )}
      >
        <Button
          onClick={() => {
        ...
        >
          {isUnfold
            ? t('define.page.resource.action.stow')
            : t('define.page.resource.action.expand')}
        </Button>
        <Coder
          domRef={codeDomRef}
          value={safeJsonStringify([data, null, 2])}
          style={{ height: 'auto' }}
        />
      </div>
    </div>
