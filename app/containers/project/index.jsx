        ...
        {projectList.length ? (
          <>
            <MenuSelect
              ...
              maxLen={10}
              menuSelectfooter={
                <div className={styles.menuSelectfooterContent}>
                  <div
                    className='more'
                    onClick={() => history.push(`/org/${orgId}/m-org-project`)}
                  >
                    <EyeOutlined className='icon' />
                    {t('define.project.viewMore')}
                  </div>
            ...
            return (
              <div className='sub-menu'>
                {subMenu.subName ? (
                  ...
                  menus.length > 1 && <Divider style={{ margin: '12px 0' }} />
                )}
