  ...
  return (
    <div style={{ width: 600, margin: '40px auto' }}>
      <Form {...layout} onFinish={onFinish} form={form}>
        <Form.Item
          label={t('define.page.sysSet.params.field.MAX_JOBS_PER_RUNNER')}
          required={true}
        >
          <Space>
            <Form.Item
        ...
        <Form.Item
          label={t('define.page.sysSet.params.field.TASK_STEP_TIMEOUT')}
          required={true}
        >
          <Space>
            <Form.Item
        ...
        >
          ...
          >
            <Option value='Permanent'>
              {t(
                'define.page.sysSet.params.field.PERIOD_OF_LOG_SAVE.option.permanent',
              )}
            </Option>
          </Select>
        </Form.Item>
