...
const OrgSetting = ({ match, userInfo, sysConfigSwitches }) => {
  ...
  useEffect(() => {
    const M = [
      {
        key: 'userRole',
        name: t('define.userRole'),
        icon: '',
        hide: !ORG_SET && !PROJECT_SET,
      },
      ...
      { key: 'vcs', name: 'VCS', icon: '', hide: !ORG_SET },
      {
        ...
        name: t('define.ssh'),
        icon: '',
        hide: !ORG_SET && !PROJECT_OPERATOR,
      },
      {
        key: 'notification',
        name: t('define.notification'),
        icon: '',
        hide: !ORG_SET,
      },
      {
        key: 'resourceAccount',
        name: t('define.resourceAccount.title'),
        icon: '',
        hide: !ORG_SET,
      },
    ].filter(it => !it.hide);
    setMenus([{ type: 'title', title: '设置' }, ...M]);
  ...
  return (
    <div className={styles.orgSet}>
      ...
      <div className='right-content'>{renderByPanel()}</div>
      {/* <Tabs
