...
const ResourceAccount = ({ orgId }) => {
  ...
  const {
    ...
    params => requestWrapper(varGroupAPI.list.bind(null, { orgId, ...params })),
    {
  ...
  // 删除
  const { run: delResourceAccount, fetches: delFetches } = useRequest(
    ({ id }) =>
      requestWrapper(varGroupAPI.del.bind(null, { orgId, id }), {
        autoSuccess: true,
      }),
    {
      manual: true,
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_text, record) => {
        ...
        return (
          <div
            className='common-table-btn-wrapper'
          ...
          >
            <Button
              ...
              onClick={() =>
                event$.emit({
                  type: 'open-resource-account-form-modal',
                  data: { id },
                })
              }
            >
  ...
  return (
    ...
    >
      <Button
        type='primary'
        onClick={() =>
          event$.emit({ type: 'open-resource-account-form-modal' })
        }
      >
